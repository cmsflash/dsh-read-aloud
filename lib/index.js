...
function apply(ctx, config) {
  ...
  ctx.inject(["tts"], (tts) => {
    for (const [id2, route] of Object.entries(config.providers)) {
      const keyFromEnv = route.apiKeyEnv === void 0 ? void 0 : process.env[route.apiKeyEnv];
      const baseFromEnv = route.baseURLEnv === void 0 ? void 0 : process.env[route.baseURLEnv];
